...
namespace com.mirle.ibg3k0.sc.WebAPI
{
    public class VehicleInfo : NancyModule
    {
        ...
        private void RegisterVehilceEvent()
        {
            ...
            Get["metrics"] = (p) =>
            {
                int total_idle_vh_clean = SCApplication.getInstance().VehicleBLL.cache.getNoExcuteMcsCmdVhCount(E_VH_TYPE.Type1);
                int total_idle_vh_Dirty = SCApplication.getInstance().VehicleBLL.cache.getNoExcuteMcsCmdVhCount(E_VH_TYPE.Type2);
