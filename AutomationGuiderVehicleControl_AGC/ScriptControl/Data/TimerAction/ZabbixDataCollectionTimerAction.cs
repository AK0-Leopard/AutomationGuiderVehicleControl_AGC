    ...
    public class ZabbixDataCollectionTimerAction : ITimerAction
    {
        ...
        public override void doProcess(object obj)
        {
            if (System.Threading.Interlocked.Exchange(ref syncPoint, 1) == 0)
            {
                try
                {
                    int total_idle_vh_clean = scApp.VehicleBLL.cache.getNoExcuteMcsCmdVhCount(E_VH_TYPE.Type1);
                    int total_idle_vh_Dirty = scApp.VehicleBLL.cache.getNoExcuteMcsCmdVhCount(E_VH_TYPE.Type2);
